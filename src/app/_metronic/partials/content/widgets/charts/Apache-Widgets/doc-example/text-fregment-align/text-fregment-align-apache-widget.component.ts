...
@Component({
  selector: 'app-apache-widget-doc-example-text-fregment-align',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleTextFregmentAlignApacheWidgetComponent {
  readonly demoId = "doc-example/text-fregment-align";
}
