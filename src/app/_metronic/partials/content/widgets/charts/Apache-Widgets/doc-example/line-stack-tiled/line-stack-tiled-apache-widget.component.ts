...
@Component({
  selector: 'app-apache-widget-doc-example-line-stack-tiled',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleLineStackTiledApacheWidgetComponent {
  readonly demoId = "doc-example/line-stack-tiled";
}
