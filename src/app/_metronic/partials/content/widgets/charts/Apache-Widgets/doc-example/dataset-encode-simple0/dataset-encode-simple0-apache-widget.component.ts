...
@Component({
  selector: 'app-apache-widget-doc-example-dataset-encode-simple0',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleDatasetEncodeSimple0ApacheWidgetComponent {
  readonly demoId = "doc-example/dataset-encode-simple0";
}
