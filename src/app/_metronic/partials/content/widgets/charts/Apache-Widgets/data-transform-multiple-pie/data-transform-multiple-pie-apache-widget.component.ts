...
@Component({
  selector: 'app-apache-widget-data-transform-multiple-pie',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DataTransformMultiplePieApacheWidgetComponent {
  readonly demoId = "data-transform-multiple-pie";
}
