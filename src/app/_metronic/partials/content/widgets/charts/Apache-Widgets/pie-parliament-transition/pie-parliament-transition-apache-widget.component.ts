...
@Component({
  selector: 'app-apache-widget-pie-parliament-transition',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class PieParliamentTransitionApacheWidgetComponent {
  readonly demoId = "pie-parliament-transition";
}
