...
@Component({
  selector: 'app-apache-widget-doc-example-pie-label-margin',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExamplePieLabelMarginApacheWidgetComponent {
  readonly demoId = "doc-example/pie-label-margin";
}
