...
@Component({
  selector: 'app-apache-widget-scatter-clustering-process',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterClusteringProcessApacheWidgetComponent {
  readonly demoId = "scatter-clustering-process";
}
