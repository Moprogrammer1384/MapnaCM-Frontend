...
@Component({
  selector: 'app-apache-widget-scatter-life-expectancy-timeline',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterLifeExpectancyTimelineApacheWidgetComponent {
  readonly demoId = "scatter-life-expectancy-timeline";
}
