...
@Component({
  selector: 'app-apache-widget-doc-example-polar-end-angle',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExamplePolarEndAngleApacheWidgetComponent {
  readonly demoId = "doc-example/polar-end-angle";
}
