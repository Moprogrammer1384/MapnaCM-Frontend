...
@Component({
  selector: 'app-apache-widget-doc-example-geo-svg-layout-basic',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGeoSvgLayoutBasicApacheWidgetComponent {
  readonly demoId = "doc-example/geo-svg-layout-basic";
}
