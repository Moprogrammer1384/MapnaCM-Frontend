...
@Component({
  selector: 'app-apache-widget-doc-example-graphic-bounding',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGraphicBoundingApacheWidgetComponent {
  readonly demoId = "doc-example/graphic-bounding";
}
