...
@Component({
  selector: 'app-apache-widget-doc-example-canvas-vs-svg-en',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleCanvasVsSvgEnApacheWidgetComponent {
  readonly demoId = "doc-example/canvas-vs-svg-en";
}
