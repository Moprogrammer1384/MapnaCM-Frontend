...
@Component({
  selector: 'app-apache-widget-scatter-logarithmic-regression',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterLogarithmicRegressionApacheWidgetComponent {
  readonly demoId = "scatter-logarithmic-regression";
}
