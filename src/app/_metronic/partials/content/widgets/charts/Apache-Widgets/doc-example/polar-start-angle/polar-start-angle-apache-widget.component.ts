...
@Component({
  selector: 'app-apache-widget-doc-example-polar-start-angle',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExamplePolarStartAngleApacheWidgetComponent {
  readonly demoId = "doc-example/polar-start-angle";
}
