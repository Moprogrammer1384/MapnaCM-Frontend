...
@Component({
  selector: 'app-apache-widget-doc-example-bar-media-timeline',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleBarMediaTimelineApacheWidgetComponent {
  readonly demoId = "doc-example/bar-media-timeline";
}
