...
@Component({
  selector: 'app-apache-widget-doc-example-mix-timeline-all',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleMixTimelineAllApacheWidgetComponent {
  readonly demoId = "doc-example/mix-timeline-all";
}
