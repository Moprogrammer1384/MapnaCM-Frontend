...
@Component({
  selector: 'app-apache-widget-doc-example-tutorial-styling-step4',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleTutorialStylingStep4ApacheWidgetComponent {
  readonly demoId = "doc-example/tutorial-styling-step4";
}
