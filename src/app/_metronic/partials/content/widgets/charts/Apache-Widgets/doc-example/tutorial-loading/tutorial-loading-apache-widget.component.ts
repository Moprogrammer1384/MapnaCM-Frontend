...
@Component({
  selector: 'app-apache-widget-doc-example-tutorial-loading',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleTutorialLoadingApacheWidgetComponent {
  readonly demoId = "doc-example/tutorial-loading";
}
