...
@Component({
  selector: 'app-apache-widget-doc-example-matrix-graph-box',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleMatrixGraphBoxApacheWidgetComponent {
  readonly demoId = "doc-example/matrix-graph-box";
}
