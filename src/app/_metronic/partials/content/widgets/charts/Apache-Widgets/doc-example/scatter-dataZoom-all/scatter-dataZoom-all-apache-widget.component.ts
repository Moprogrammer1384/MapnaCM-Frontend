...
@Component({
  selector: 'app-apache-widget-doc-example-scatter-datazoom-all',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleScatterDataZoomAllApacheWidgetComponent {
  readonly demoId = "doc-example/scatter-dataZoom-all";
}
