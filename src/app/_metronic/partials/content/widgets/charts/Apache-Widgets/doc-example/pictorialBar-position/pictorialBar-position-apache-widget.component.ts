...
@Component({
  selector: 'app-apache-widget-doc-example-pictorialbar-position',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExamplePictorialBarPositionApacheWidgetComponent {
  readonly demoId = "doc-example/pictorialBar-position";
}
