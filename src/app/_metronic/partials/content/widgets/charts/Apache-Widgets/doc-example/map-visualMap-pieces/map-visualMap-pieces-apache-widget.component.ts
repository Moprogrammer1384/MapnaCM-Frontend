...
@Component({
  selector: 'app-apache-widget-doc-example-map-visualmap-pieces',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleMapVisualMapPiecesApacheWidgetComponent {
  readonly demoId = "doc-example/map-visualMap-pieces";
}
