...
@Component({
  selector: 'app-apache-widget-scatter-exponential-regression',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterExponentialRegressionApacheWidgetComponent {
  readonly demoId = "scatter-exponential-regression";
}
