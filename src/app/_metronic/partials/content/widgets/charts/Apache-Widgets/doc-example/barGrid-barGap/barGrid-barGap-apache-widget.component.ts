...
@Component({
  selector: 'app-apache-widget-doc-example-bargrid-bargap',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleBarGridBarGapApacheWidgetComponent {
  readonly demoId = "doc-example/barGrid-barGap";
}
