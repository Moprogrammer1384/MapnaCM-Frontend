...
@Component({
  selector: 'app-apache-widget-doc-example-aria-decal-newspaper',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleAriaDecalNewspaperApacheWidgetComponent {
  readonly demoId = "doc-example/aria-decal-newspaper";
}
