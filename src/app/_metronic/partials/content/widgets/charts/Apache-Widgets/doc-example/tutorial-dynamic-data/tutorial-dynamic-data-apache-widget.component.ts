...
@Component({
  selector: 'app-apache-widget-doc-example-tutorial-dynamic-data',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleTutorialDynamicDataApacheWidgetComponent {
  readonly demoId = "doc-example/tutorial-dynamic-data";
}
