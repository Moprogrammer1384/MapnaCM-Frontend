...
@Component({
  selector: 'app-apache-widget-doc-example-value-animation-simple',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleValueAnimationSimpleApacheWidgetComponent {
  readonly demoId = "doc-example/value-animation-simple";
}
