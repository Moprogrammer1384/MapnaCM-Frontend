...
@Component({
  selector: 'app-apache-widget-treemap-sunburst-transition',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class TreemapSunburstTransitionApacheWidgetComponent {
  readonly demoId = "treemap-sunburst-transition";
}
