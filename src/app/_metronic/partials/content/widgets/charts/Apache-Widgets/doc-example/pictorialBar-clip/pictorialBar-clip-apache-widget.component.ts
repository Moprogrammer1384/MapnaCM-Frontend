...
@Component({
  selector: 'app-apache-widget-doc-example-pictorialbar-clip',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExamplePictorialBarClipApacheWidgetComponent {
  readonly demoId = "doc-example/pictorialBar-clip";
}
