...
@Component({
  selector: 'app-apache-widget-matrix-correlation-heatmap',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class MatrixCorrelationHeatmapApacheWidgetComponent {
  readonly demoId = "matrix-correlation-heatmap";
}
