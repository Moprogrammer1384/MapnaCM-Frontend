...
@Component({
  selector: 'app-apache-widget-doc-example-geo-svg-named-basic',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGeoSvgNamedBasicApacheWidgetComponent {
  readonly demoId = "doc-example/geo-svg-named-basic";
}
