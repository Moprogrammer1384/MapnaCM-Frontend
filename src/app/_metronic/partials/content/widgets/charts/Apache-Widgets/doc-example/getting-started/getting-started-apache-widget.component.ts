...
@Component({
  selector: 'app-apache-widget-doc-example-getting-started',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGettingStartedApacheWidgetComponent {
  readonly demoId = "doc-example/getting-started";
}
