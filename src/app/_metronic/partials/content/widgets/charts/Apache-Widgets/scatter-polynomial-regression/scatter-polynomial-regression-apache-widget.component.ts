...
@Component({
  selector: 'app-apache-widget-scatter-polynomial-regression',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterPolynomialRegressionApacheWidgetComponent {
  readonly demoId = "scatter-polynomial-regression";
}
