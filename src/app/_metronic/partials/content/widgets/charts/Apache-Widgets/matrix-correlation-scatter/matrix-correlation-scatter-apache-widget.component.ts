...
@Component({
  selector: 'app-apache-widget-matrix-correlation-scatter',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class MatrixCorrelationScatterApacheWidgetComponent {
  readonly demoId = "matrix-correlation-scatter";
}
