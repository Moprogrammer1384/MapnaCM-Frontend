...
@Component({
  selector: 'app-apache-widget-pictorialbar-bar-transition',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class PictorialBarBarTransitionApacheWidgetComponent {
  readonly demoId = "pictorialBar-bar-transition";
}
