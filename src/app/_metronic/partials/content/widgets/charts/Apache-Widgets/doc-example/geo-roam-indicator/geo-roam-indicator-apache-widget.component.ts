...
@Component({
  selector: 'app-apache-widget-doc-example-geo-roam-indicator',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGeoRoamIndicatorApacheWidgetComponent {
  readonly demoId = "doc-example/geo-roam-indicator";
}
