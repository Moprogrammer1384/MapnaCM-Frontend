...
@Component({
  selector: 'app-apache-widget-doc-example-aria-decal-simple',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleAriaDecalSimpleApacheWidgetComponent {
  readonly demoId = "doc-example/aria-decal-simple";
}
