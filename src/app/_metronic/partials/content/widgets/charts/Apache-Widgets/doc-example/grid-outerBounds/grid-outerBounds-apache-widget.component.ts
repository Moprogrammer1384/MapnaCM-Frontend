...
@Component({
  selector: 'app-apache-widget-doc-example-grid-outerbounds',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleGridOuterBoundsApacheWidgetComponent {
  readonly demoId = "doc-example/grid-outerBounds";
}
