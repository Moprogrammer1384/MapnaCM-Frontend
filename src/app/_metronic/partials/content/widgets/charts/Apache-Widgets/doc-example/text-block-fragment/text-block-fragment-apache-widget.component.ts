...
@Component({
  selector: 'app-apache-widget-doc-example-text-block-fragment',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleTextBlockFragmentApacheWidgetComponent {
  readonly demoId = "doc-example/text-block-fragment";
}
