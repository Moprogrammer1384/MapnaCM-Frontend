...
@Component({
  selector: 'app-apache-widget-doc-example-label-position',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class DocExampleLabelPositionApacheWidgetComponent {
  readonly demoId = "doc-example/label-position";
}
