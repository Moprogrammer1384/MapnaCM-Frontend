...
@Component({
  selector: 'app-apache-widget-scatter-linear-regression',
  standalone: true,
  imports: [ApacheEchartsComponent],
  template: `<app-apache-echarts [demoId]="demoId" height="420px"></app-apache-echarts>`,
})
export class ScatterLinearRegressionApacheWidgetComponent {
  readonly demoId = "scatter-linear-regression";
}
